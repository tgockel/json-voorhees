...
/// Coerce the current element of \a from into an \c std::string.
JSONV_PUBLIC std::string coerce_string(reader& from);
/// \}
...
/// TODO
JSONV_PUBLIC double coerce_decimal(reader& from);
/// \}
...
/// TODO
JSONV_PUBLIC bool coerce_boolean(reader& from);
/// \}
