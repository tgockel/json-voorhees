 ...
 *           throw).
**/
JSONV_NODISCARD JSONV_PUBLIC bool can_coerce(const kind& from, const kind& to);
...
**/
JSONV_NODISCARD JSONV_PUBLIC bool can_coerce(const value& from, const kind& to);
...
**/
JSONV_NODISCARD JSONV_PUBLIC std::map<std::string, value> coerce_object(const value& from);
...
**/
JSONV_NODISCARD JSONV_PUBLIC std::vector<value> coerce_array(const value& from);
...
**/
JSONV_NODISCARD JSONV_PUBLIC double coerce_decimal(const value& from);
...
**/
JSONV_NODISCARD JSONV_PUBLIC bool coerce_boolean(const value& from);
...
**/
JSONV_NODISCARD JSONV_PUBLIC value coerce_merge(value a, value b);
