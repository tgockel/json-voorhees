...
static std::string make_duplicate_type_errmsg(std::string_view operation, const std::type_index& type)
{
...
duplicate_type_error::duplicate_type_error(std::string_view operation, const std::type_index& type) :
